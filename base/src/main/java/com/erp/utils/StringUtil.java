...
/**
    ...
    */
	...
	/**
     * <p>int 형식의 숫자에 세자리마다 콤마를 찍는다.</p>
     *
     * @param int  입력받는 문자열
     * @return String
     */
    public static String  toNumberCommaFormat(int num) {
        DecimalFormat df = new DecimalFormat("#,###");
        return df.format(num);
    }

    /**
     * <p>발행번호 포멧팅xx-xxxx-xxxx</p>
     *
     * @param String  입력받는 문자열
     * @return String
     */
    public static String toCardFormat(String cardNo) {
        if( cardNo != null ){
            return cardNo.substring(0,2).concat("-").concat(cardNo.substring(2,6)).concat("-").concat(cardNo.substring(6,10));
        }else{
            return null;
        }
    }
